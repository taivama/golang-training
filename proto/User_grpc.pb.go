...
func (c *userServiceClient) Register(ctx context.Context, in *User, opts ...grpc.CallOption) (*RegisterResponse, error) {
...
func (UnimplementedUserServiceServer) Register(context.Context, *User) (*RegisterResponse, error) {
